...
```
## instances -> submission file
```
usage: instances2submission.py [-h]
                               path_to_instances_dir path_to_submission_file

makes submission file from instances generated by apply_ransac.py present in
folder path_to_instances_dir

positional arguments:
  path_to_instances_dir
